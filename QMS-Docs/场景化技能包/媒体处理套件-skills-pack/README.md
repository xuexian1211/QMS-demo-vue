...
本技能包由 FastSkills (https://github.com/PureVibeCoder/fastskills) 聚合提供，共包含 10 个技能。
...
- **videocut:安装** (`videocut-install`)
- **videocut:剪口播** (`videocut-speech-cut`)
- **videocut:剪辑** (`videocut-edit`)
- **videocut:字幕** (`videocut-subtitles`)
- **videocut:自更新** (`videocut-self-update`)
