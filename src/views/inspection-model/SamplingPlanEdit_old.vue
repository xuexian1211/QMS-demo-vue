<template>
    <div class="page-container">
        ...
        <!-- 规则编辑弹窗 -->
        <a-modal v-model:visible="ruleModalVisible" :title="isEditRule ? '编辑规则' : '新增规则'" width="800px" @ok="saveRule">
            <a-form layout="vertical" :model="ruleForm">
                ...
                <template v-if="form.samplingMethod === 'STANDARD_BASED'">
                    ...
                    <a-table :columns="detailColumns" :data-source="ruleForm.details" :pagination="false" size="small"
                        bordered />
                </template>
            </a-form>
        </a-modal>
