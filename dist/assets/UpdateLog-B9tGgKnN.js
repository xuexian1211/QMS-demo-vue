var Nn=Object.defineProperty;var Mn=(t,n,e)=>n in t?Nn(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e;var C=(t,n,e)=>Mn(t,typeof n!="symbol"?n+"":n,e);import{d as bn,r as on,m as On,k as ln,c as b,e as U,p as Un,s as cn,F as kn,t as pn,x as wn,o as f}from"./index-B_-nmmkE.js";import{_ as Qn}from"./_plugin-vue_export-helper-DlAUqK2U.js";const Bn=`# 安徽舜富精密压铸科技有限公司 QMS质量管理系统完整解决方案
...
- 文档类型：项目概述与背景分析分册
- 适用对象：安徽舜富精密压铸科技有限公司
- 文档密级：内部机密`,Fn=`# 安徽舜富精密压铸科技有限公司 QMS质量管理系统
...
- 创建日期：2026年1月15日
- 分册编号：10
- 文档密级：内部机密`,Kn=`# 安徽舜富精密压铸科技有限公司 QMS质量管理系统\r
\r
...
\r
**我们承诺：按照本方案实施，确保项目成功，实现所有预期目标和价值！！**`,Xn=`# 舜富QMS系统 - API接口设计规范
...
**文档管理模块详细实现规范完成。接下来继续实现供应商管理模块详细规范。**`,Jn=`# 舜富QMS系统 - 培训管理模块详细实现规范
...
`,Se=`基于需求方案及前期设计的检验模型，**实验室送检（Laboratory Testing）**模块作为高精度、专项理化分析的核心，其设计旨在确保原材料及产品符合特定技术标准，并提供自动化的数据存证 。\r
...
3. 处置：实验员定期清理样品，并在系统中勾选“已销毁”或“退还”，确保台账实物一致。`,Ce=`# IQC 来料检验执行与 MRB 进料不良异常处理 — 详细设计文档\r
\r
> **版本**: V2.0  \r
> **日期**: 2026-03-02  \r
...
`,De=`# 不良现象与字典库 (Defect Phenomenon / Cause) - 详细设计文档\r
\r
## 1. 模块概述\r
**模块名称**：质量缺陷与失效原因特征库\r
...
`,Pe=`# 抽样方案管理 (Sampling Plan) - 详细设计文档\r
\r
## 1. 模块概述\r
...
`,ve=`# 检验方法管理 (Inspection Method) - 详细设计文档\r
\r
## 1. 模块概述\r
...
`,Ne="# 量检具台账与类型管理 (Gauge Ledger) - 详细设计文档\r\n\r\n## 1. 模块概述\r\n**模块名称**：量检具管理台账与层级树\r\n**所属子系统**：质量主数据模块 (Quality Master Data) / 检验支持模块\r\n**目标**：构建全厂测量系统资产（卡尺、硬度仪、三坐标等设备）的全生命周期管理跟踪卡。支持设备的层级分类、高精度测量属性配置并核心支撑MSA（测量系统分析）的依赖前提和定期设备送校提醒。\r\n\r\n## 2. 界面布局与交互设计\r\n### 2.1 “左树右表” 复杂布局 (Split Layout)\r\n页面布局采用了高频的高级左树右表结构：\r\n- **左侧容器 (Left Panel - Tree)**：使用 `a-tree` 组建渲染量检具分类树。\r\n  - 支持节点过滤搜索（如输入“卡尺”过滤树状节点）。\r\n  - 在每个节点上支持悬浮动作组（新增子类、编辑本类、删除大类）。\r\n- **右侧工作台 (Right Panel - Ledger List)**：设备明细列表。\r\n  - 只有在选中左侧设备类目后，右侧才会呈现挂属于此品类或此族系下的设备实体。\r\n  - 带有醒目的表头展示目前选中的大类其精度或“是否需MSA”。\r\n\r\n### 2.2 视觉驱动的阈值警告\r\n在量检具中，“校准到期监控”是最为关键的质量管理动作。\r\n- 在表格和详情中渲染 `nextCalDate` 时加入强校验逻辑：\r\n  - 如果日期已逾期 ( `<0 days` )：使用红色警报 `red`\r\n  - 如果在即将逾期范围内 ( `<14 days` )：使用警戒色 `orange`\r\n  - 正常在案：绿色 `green`\r\n\r\n## 3. 核心功能设计\r\n### 3.1 量检具类型属性定义 (Gauge Type Tree)\r\n类型不仅仅是个文本标签，他附带两大质量属性：\r\n- `precision` (分辨率/精度)：如0.01mm，这个精度将直接预设到新建的具体卡尺上。\r\n- `isMsaRequired` (是否需要MSA校验)：布尔值控制，如果是，未来在进行 GR&R 试验分析时，该类的设备才会被强制要求挑选出做验证。\r\n\r\n### 3.2 周期性校验 (Calibration Cycle)\r\n这部分由核心的生命周期字段控制：\r\n- `status`: 在用、校准中、封存、报废。\r\n- 如果设备状态被标记为`CALIBRATING`(校准中)或`SCRAPPED`(报废)，在检验员准备做 IPQC/OQC 选择所用设备输入时，下拉框会对其进行自动防呆拦截，不可选用。\r\n\r\n## 4. 数据模型 (Data Model)\r\n**类型节点实体 (`GaugeType`)**:\r\n- `id`, `parentId`, `typeName`: 维护无限极树的基础。\r\n- `precision`: 缺省精度\r\n- `isMsaRequired`: 强制MSA分析标记\r\n\r\n**量检具台账明细 (`GaugeLedger`)**:\r\n- `gaugeNo`: 设备唯一资产编号\r\n- `gaugeName`, `model`, `manufacturer`: 基本名牌参数\r\n- `accuracy`, `resolution`, `measureRange`: 测定边界能力\r\n- `calibrationCycle`: 周期(比如 12个月)\r\n- `lastCalDate`: 上次强检时间\r\n- `nextCalDate`: 证书失效/下次强检时间(触发报警核心字段)\r\n- `status`: 生命周期（`IN_USE`, `CALIBRATING`, `SEALED`, `SCRAPPED`）\r\n- `custodian`, `location`: 物理存放与保管责任追踪。\r\n\r\n## 5. 约束与规则\r\n- **强校准阻断**：当 `nextCalDate` 已过期，其对应的台账状态建议必须进入锁定态，不得在生产检验流程的下拉列表中再被选中作为“测定依据”，否则极易导致产品错漏判的质量事故。\r\n- **关联删除限制**：如果要删除左侧树节点类型时，系统必须防呆确保其下面未挂靠任何存量（哪怕是报废的）台账。\r\n";function Z(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var N=Z();function Sn(t){N=t}var h={exec:()=>null};function T(t,n=""){let e=typeof t=="string"?t:t.source,a={replace:(r,s)=>{let o=typeof s=="string"?s:s.source;return o=o.replace(I.caret,"$1"),e=e.replace(r,o),a},getRegex:()=>new RegExp(e,n)};return a}var Me=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),I={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:t=>new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}#`),htmlBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:t=>new RegExp(`^ {0,${Math.min(3,t-1)}}>`)},be=/^(?:[ \t]*(?:\n|$))+/,Oe=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Ue=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,B=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ke=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,J=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Cn=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Rn=T(Cn).replace(/bull/g,J).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),we=T(Cn).replace(/bull/g,J).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),$=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Qe=/^[^\n]+/,nn=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Be=T(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",nn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Ve=T(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,J).getRegex(),G="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",en=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Fe=T("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",en).replace("tag",G).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),In=T($).replace("hr",B).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",G).getRegex(),xe=T(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",In).getRegex(),tn={blockquote:xe,code:Oe,def:Be,fences:Ue,heading:ke,hr:B,html:Fe,lheading:Rn,list:Ve,newline:be,paragraph:In,table:h,text:Qe},un=T("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",B).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",G).getRegex(),He={...tn,lheading:we,table:un,paragraph:T($).replace("hr",B).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",un).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",G).getRegex()},qe={...tn,html:T(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",en).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:h,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:T($).replace("hr",B).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Rn).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Ge=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ye=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,En=/^( {2,}|\\)\n(?!\s*$)/,ze=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Y=/[\p{P}\p{S}]/u,rn=/[\s\p{P}\p{S}]/u,yn=/[^\s\p{P}\p{S}]/u,je=T(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,rn).getRegex(),Dn=/(?!~)[\p{P}\p{S}]/u,We=/(?!~)[\s\p{P}\p{S}]/u,Ke=/(?:[^\s\p{P}\p{S}]|~)/u,Pn=/(?![*_])[\p{P}\p{S}]/u,Xe=/(?![*_])[\s\p{P}\p{S}]/u,Ze=/(?:[^\s\p{P}\p{S}]|[*_])/u,Je=T(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Me?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),vn=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,$e=T(vn,"u").replace(/punct/g,Y).getRegex(),nt=T(vn,"u").replace(/punct/g,Dn).getRegex(),Ln="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",et=T(Ln,"gu").replace(/notPunctSpace/g,yn).replace(/punctSpace/g,rn).replace(/punct/g,Y).getRegex(),tt=T(Ln,"gu").replace(/notPunctSpace/g,Ke).replace(/punctSpace/g,We).replace(/punct/g,Dn).getRegex(),rt=T("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,yn).replace(/punctSpace/g,rn).replace(/punct/g,Y).getRegex(),at=T(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,Pn).getRegex(),it="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",st=T(it,"gu").replace(/notPunctSpace/g,Ze).replace(/punctSpace/g,Xe).replace(/punct/g,Pn).getRegex(),ot=T(/\\(punct)/,"gu").replace(/punct/g,Y).getRegex(),lt=T(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),ct=T(en).replace("(?:-->|$)","-->").getRegex(),pt=T("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",ct).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),x=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,ut=T(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",x).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),fn=T(/^!?\[(label)\]\[(ref)\]/).replace("label",x).replace("ref",nn).getRegex(),hn=T(/^!?\[(ref)\](?:\[\])?/).replace("ref",nn).getRegex(),dt=T("reflink|nolink(?!\\()","g").replace("reflink",fn).replace("nolink",hn).getRegex(),dn=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,an={_backpedal:h,anyPunctuation:ot,autolink:lt,blockSkip:Je,br:En,code:Ye,del:h,delLDelim:h,delRDelim:h,emStrongLDelim:$e,emStrongRDelimAst:et,emStrongRDelimUnd:rt,escape:Ge,link:ut,nolink:hn,punctuation:je,reflink:fn,reflinkSearch:dt,tag:pt,text:ze,url:h},mt={...an,link:T(/^!?\[(label)\]\((.*?)\)/).replace("label",x).getRegex(),reflink:T(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",x).getRegex()},W={...an,emStrongRDelimAst:tt,emStrongLDelim:nt,delLDelim:at,delRDelim:st,url:T(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",dn).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:T(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",dn).getRegex()},gt={...W,br:T(En).replace("{2,}","*").getRegex(),text:T(W.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},V={normal:tn,gfm:He,pedantic:qe},k={normal:an,gfm:W,breaks:gt,pedantic:mt},Tt={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},mn=t=>Tt[t];function P(t,n){if(n){if(I.escapeTest.test(t))return t.replace(I.escapeReplace,mn)}else if(I.escapeTestNoEncode.test(t))return t.replace(I.escapeReplaceNoEncode,mn);return t}function gn(t){try{t=encodeURI(t).replace(I.percentDecode,"%")}catch{return null}return t}function Tn(t,n){var s;let e=t.replace(I.findPipe,(o,i,c)=>{let l=!1,u=i;for(;--u>=0&&c[u]==="\\";)l=!l;return l?"|":" |"}),a=e.split(I.splitPipe),r=0;if(a[0].trim()||a.shift(),a.length>0&&!((s=a.at(-1))!=null&&s.trim())&&a.pop(),n)if(a.length>n)a.splice(n);else for(;a.length<n;)a.push("");for(;r<a.length;r++)a[r]=a[r].trim().replace(I.slashPipe,"|");return a}function w(t,n,e){let a=t.length;if(a===0)return"";let r=0;for(;r<a&&t.charAt(a-r-1)===n;)r++;return t.slice(0,a-r)}function At(t,n){if(t.indexOf(n[1])===-1)return-1;let e=0;for(let a=0;a<t.length;a++)if(t[a]==="\\")a++;else if(t[a]===n[0])e++;else if(t[a]===n[1]&&(e--,e<0))return a;return e>0?-2:-1}function St(t,n=0){let e=n,a="";for(let r of t)if(r==="	"){let s=4-e%4;a+=" ".repeat(s),e+=s}else a+=r,e++;return a}function An(t,n,e,a,r){let s=n.href,o=n.title||null,i=t[1].replace(r.other.outputLinkReplace,"$1");a.state.inLink=!0;let c={type:t[0].charAt(0)==="!"?"image":"link",raw:e,href:s,title:o,text:i,tokens:a.inlineTokens(i)};return a.state.inLink=!1,c}function Ct(t,n,e){let a=t.match(e.other.indentCodeCompensation);if(a===null)return n;let r=a[1];return n.split(`
`).map(s=>{let o=s.match(e.other.beginningSpace);if(o===null)return s;let[i]=o;return i.length>=r.length?s.slice(r.length):s}).join(`
`)}var H=class{constructor(t){C(this,"options");C(this,"rules");C(this,"lexer");this.options=t||N}space(t){let n=this.rules.block.newline.exec(t);if(n&&n[0].length>0)return{type:"space",raw:n[0]}}code(t){let n=this.rules.block.code.exec(t);if(n){let e=n[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:n[0],codeBlockStyle:"indented",text:this.options.pedantic?e:w(e,`
`)}}}fences(t){let n=this.rules.block.fences.exec(t);if(n){let e=n[0],a=Ct(e,n[3]||"",this.rules);return{type:"code",raw:e,lang:n[2]?n[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):n[2],text:a}}}heading(t){let n=this.rules.block.heading.exec(t);if(n){let e=n[2].trim();if(this.rules.other.endingHash.test(e)){let a=w(e,"#");(this.options.pedantic||!a||this.rules.other.endingSpaceChar.test(a))&&(e=a.trim())}return{type:"heading",raw:n[0],depth:n[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(t){let n=this.rules.block.hr.exec(t);if(n)return{type:"hr",raw:w(n[0],`
`)}}blockquote(t){let n=this.rules.block.blockquote.exec(t);if(n){let e=w(n[0],`
`).split(`
...
`}strong({tokens:t}){return`<strong>${this.parser.parseInline(t)}</strong>`}em({tokens:t}){return`<em>${this.parser.parseInline(t)}</em>`}codespan({text:t}){return`<code>${P(t,!0)}</code>`}br(t){return"<br>"}del({tokens:t}){return`<del>${this.parser.parseInline(t)}</del>`}link({href:t,title:n,tokens:e}){let a=this.parser.parseInline(e),r=gn(t);if(r===null)return a;t=r;let s='<a href="'+t+'"';return n&&(s+=' title="'+P(n)+'"'),s+=">"+a+"</a>",s}image({href:t,title:n,text:e,tokens:a}){a&&(e=this.parser.parseInline(a,this.parser.textRenderer));let r=gn(t);if(r===null)return P(e);t=r;let s=`<img src="${t}" alt="${P(e)}"`;return n&&(s+=` title="${P(n)}"`),s+=">",s}text(t){return"tokens"in t&&t.tokens?this.parser.parseInline(t.tokens):"escaped"in t&&t.escaped?t.text:P(t.text)}},sn=class{strong({text:t}){return t}em({text:t}){return t}codespan({text:t}){return t}del({text:t}){return t}html({text:t}){return t}text({text:t}){return t}link({text:t}){return""+t}image({text:t}){return""+t}br(){return""}checkbox({raw:t}){return t}},y=class X{constructor(n){C(this,"options");C(this,"renderer");C(this,"textRenderer");this.options=n||N,this.options.renderer=this.options.renderer||new q,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new sn}static parse(n,e){return new X(e).parse(n)}static parseInline(n,e){return new X(e).parseInline(n)}parse(n){var a,r;let e="";for(let s=0;s<n.length;s++){let o=n[s];if((r=(a=this.options.extensions)==null?void 0:a.renderers)!=null&&r[o.type]){let c=o,l=this.options.extensions.renderers[c.type].call({parser:this},c);if(l!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(c.type)){e+=l||"";continue}}let i=o;switch(i.type){case"space":{e+=this.renderer.space(i);break}case"hr":{e+=this.renderer.hr(i);break}case"heading":{e+=this.renderer.heading(i);break}case"code":{e+=this.renderer.code(i);break}case"table":{e+=this.renderer.table(i);break}case"blockquote":{e+=this.renderer.blockquote(i);break}case"list":{e+=this.renderer.list(i);break}case"checkbox":{e+=this.renderer.checkbox(i);break}case"html":{e+=this.renderer.html(i);break}case"def":{e+=this.renderer.def(i);break}case"paragraph":{e+=this.renderer.paragraph(i);break}case"text":{e+=this.renderer.text(i);break}default:{let c='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(c),"";throw new Error(c)}}}return e}parseInline(n,e=this.renderer){var r,s;let a="";for(let o=0;o<n.length;o++){let i=n[o];if((s=(r=this.options.extensions)==null?void 0:r.renderers)!=null&&s[i.type]){let l=this.options.extensions.renderers[i.type].call({parser:this},i);if(l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)){a+=l||"";continue}}let c=i;switch(c.type){case"escape":{a+=e.text(c);break}case"html":{a+=e.html(c);break}case"link":{a+=e.link(c);break}case"image":{a+=e.image(c);break}case"checkbox":{a+=e.checkbox(c);break}case"strong":{a+=e.strong(c);break}case"em":{a+=e.em(c);break}case"codespan":{a+=e.codespan(c);break}case"br":{a+=e.br(c);break}case"del":{a+=e.del(c);break}case"text":{a+=e.text(c);break}default:{let l='Token with "'+c.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return a}},F,Q=(F=class{constructor(t){C(this,"options");C(this,"block");this.options=t||N}preprocess(t){return t}postprocess(t){return t}processAllTokens(t){return t}emStrongMask(t){return t}provideLexer(){return this.block?E.lex:E.lexInline}provideParser(){return this.block?y.parse:y.parseInline}},C(F,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens","emStrongMask"])),C(F,"passThroughHooksRespectAsync",new Set(["preprocess","postprocess","processAllTokens"])),F),Rt=class{constructor(...t){C(this,"defaults",Z());C(this,"options",this.setOptions);C(this,"parse",this.parseMarkdown(!0));C(this,"parseInline",this.parseMarkdown(!1));C(this,"Parser",y);C(this,"Renderer",q);C(this,"TextRenderer",sn);C(this,"Lexer",E);C(this,"Tokenizer",H);C(this,"Hooks",Q);this.use(...t)}walkTokens(t,n){var a,r;let e=[];for(let s of t)switch(e=e.concat(n.call(this,s)),s.type){case"table":{let o=s;for(let i of o.header)e=e.concat(this.walkTokens(i.tokens,n));for(let i of o.rows)for(let c of i)e=e.concat(this.walkTokens(c.tokens,n));break}case"list":{let o=s;e=e.concat(this.walkTokens(o.items,n));break}default:{let o=s;(r=(a=this.defaults.extensions)==null?void 0:a.childTokens)!=null&&r[o.type]?this.defaults.extensions.childTokens[o.type].forEach(i=>{let c=o[i].flat(1/0);e=e.concat(this.walkTokens(c,n))}):o.tokens&&(e=e.concat(this.walkTokens(o.tokens,n)))}}return e}use(...t){let n=this.defaults.extensions||{renderers:{},childTokens:{}};return t.forEach(e=>{let a={...e};if(a.async=this.defaults.async||a.async||!1,e.extensions&&(e.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){let s=n.renderers[r.name];s?n.renderers[r.name]=function(...o){let i=r.renderer.apply(this,o);return i===!1&&(i=s.apply(this,o)),i}:n.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let s=n[r.level];s?s.unshift(r.tokenizer):n[r.level]=[r.tokenizer],r.start&&(r.level==="block"?n.startBlock?n.startBlock.push(r.start):n.startBlock=[r.start]:r.level==="inline"&&(n.startInline?n.startInline.push(r.start):n.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(n.childTokens[r.name]=r.childTokens)}),a.extensions=n),e.renderer){let r=this.defaults.renderer||new q(this.defaults);for(let s in e.renderer){if(!(s in r))throw new Error(`renderer '${s}' does not exist`);if(["options","parser"].includes(s))continue;let o=s,i=e.renderer[o],c=r[o];r[o]=(...l)=>{let u=i.apply(r,l);return u===!1&&(u=c.apply(r,l)),u||""}}a.renderer=r}if(e.tokenizer){let r=this.defaults.tokenizer||new H(this.defaults);for(let s in e.tokenizer){if(!(s in r))throw new Error(`tokenizer '${s}' does not exist`);if(["options","rules","lexer"].includes(s))continue;let o=s,i=e.tokenizer[o],c=r[o];r[o]=(...l)=>{let u=i.apply(r,l);return u===!1&&(u=c.apply(r,l)),u}}a.tokenizer=r}if(e.hooks){let r=this.defaults.hooks||new Q;for(let s in e.hooks){if(!(s in r))throw new Error(`hook '${s}' does not exist`);if(["options","block"].includes(s))continue;let o=s,i=e.hooks[o],c=r[o];Q.passThroughHooks.has(s)?r[o]=l=>{if(this.defaults.async&&Q.passThroughHooksRespectAsync.has(s))return(async()=>{let m=await i.call(r,l);return c.call(r,m)})();let u=i.call(r,l);return c.call(r,u)}:r[o]=(...l)=>{if(this.defaults.async)return(async()=>{let m=await i.apply(r,l);return m===!1&&(m=await c.apply(r,l)),m})();let u=i.apply(r,l);return u===!1&&(u=c.apply(r,l)),u}}a.hooks=r}if(e.walkTokens){let r=this.defaults.walkTokens,s=e.walkTokens;a.walkTokens=function(o){let i=[];return i.push(s.call(this,o)),r&&(i=i.concat(r.call(this,o))),i}}this.defaults={...this.defaults,...a}}),this}setOptions(t){return this.defaults={...this.defaults,...t},this}lexer(t,n){return E.lex(t,n??this.defaults)}parser(t,n){return y.parse(t,n??this.defaults)}parseMarkdown(t){return(n,e)=>{let a={...e},r={...this.defaults,...a},s=this.onError(!!r.silent,!!r.async);if(this.defaults.async===!0&&a.async===!1)return s(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof n>"u"||n===null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof n!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(n)+", string expected"));if(r.hooks&&(r.hooks.options=r,r.hooks.block=t),r.async)return(async()=>{let o=r.hooks?await r.hooks.preprocess(n):n,i=await(r.hooks?await r.hooks.provideLexer():t?E.lex:E.lexInline)(o,r),c=r.hooks?await r.hooks.processAllTokens(i):i;r.walkTokens&&await Promise.all(this.walkTokens(c,r.walkTokens));let l=await(r.hooks?await r.hooks.provideParser():t?y.parse:y.parseInline)(c,r);return r.hooks?await r.hooks.postprocess(l):l})().catch(s);try{r.hooks&&(n=r.hooks.preprocess(n));let o=(r.hooks?r.hooks.provideLexer():t?E.lex:E.lexInline)(n,r);r.hooks&&(o=r.hooks.processAllTokens(o)),r.walkTokens&&this.walkTokens(o,r.walkTokens);let i=(r.hooks?r.hooks.provideParser():t?y.parse:y.parseInline)(o,r);return r.hooks&&(i=r.hooks.postprocess(i)),i}catch(o){return s(o)}}}onError(t,n){return e=>{if(e.message+=`
Please report this to https://github.com/markedjs/marked.`,t){let a="<p>An error occurred:</p><pre>"+P(e.message+"",!0)+"</pre>";return n?Promise.resolve(a):a}if(n)return Promise.reject(e);throw e}}},_=new Rt;function A(t,n){return _.parse(t,n)}A.options=A.setOptions=function(t){return _.setOptions(t),A.defaults=_.defaults,Sn(A.defaults),A};A.getDefaults=Z;A.defaults=N;A.use=function(...t){return _.use(...t),A.defaults=_.defaults,Sn(A.defaults),A};A.walkTokens=function(t,n){return _.walkTokens(t,n)};A.parseInline=_.parseInline;A.Parser=y;A.parser=y.parse;A.Renderer=q;A.TextRenderer=sn;A.Lexer=E;A.lexer=E.lex;A.Tokenizer=H;A.Hooks=Q;A.parse=A;A.options;A.setOptions;A.use;A.walkTokens;A.parseInline;y.parse;E.lex;const It={class:"prd-container"},Et={class:"prd-sidebar"},yt={key:1,style:{padding:"24px","text-align":"center",color:"#999"}},Dt={class:"prd-content"},Pt={class:"doc-title"},vt=["innerHTML"],Lt={key:1,class:"text-body"},ft={key:1,class:"empty-state"},ht=bn({__name:"UpdateLog",setup(t){const n=Object.assign({"/PRD/QMS-BRD/初始需求/00-文档索引总览.md":Bn,"/PRD/QMS-BRD/初始需求/01-项目概述与背景分析.md":Vn,"/PRD/QMS-BRD/初始需求/02-项目目标与成功标准.md":Fn,"/PRD/QMS-BRD/初始需求/03-项目范围与边界定义.md":xn,"/PRD/QMS-BRD/初始需求/04-系统架构与技术方案.md":Hn,"/PRD/QMS-BRD/初始需求/05-核心功能模块(1-5章).md":qn,"/PRD/QMS-BRD/初始需求/06-客诉8D管理模块.md":Gn,"/PRD/QMS-BRD/初始需求/07-IQC检验体系模块.md":Yn,"/PRD/QMS-BRD/初始需求/08-MSA-SPC-知识库模块.md":zn,"/PRD/QMS-BRD/初始需求/09-供应商质量管理模块.md":jn,"/PRD/QMS-BRD/初始需求/10-文档控制到培训管理.md":Wn,"/PRD/QMS-BRD/初始需求/11-项目监控与持续改进.md":Kn,"/PRD/QMS-BRD/需求规范/舜富QMS系统API接口设计规范.md":Xn,"/PRD/QMS-BRD/需求规范/舜富QMS系统供应商管理模块详细实现规范.md":Zn,"/PRD/QMS-BRD/需求规范/舜富QMS系统培训管理模块详细实现规范.md":Jn,"/PRD/QMS-BRD/需求规范/舜富QMS系统审核管理模块详细实现规范.md":$n,"/PRD/QMS-BRD/需求规范/舜富QMS系统报表分析与决策支持模块详细实现规范.md":ne,"/PRD/QMS-BRD/需求规范/舜富QMS系统数据库设计规范.md":ee,"/PRD/QMS-BRD/需求规范/舜富QMS系统核心模块详细实现规范.md":te,"/PRD/QMS-BRD/需求规范/舜富QMS系统知识库管理模块详细实现规范.md":re,"/PRD/QMS-BRD/需求规范/舜富QMS系统质量检验模块详细实现规范.md":ae,"/PRD/QMS系统菜单重构方案.md":ie,"/PRD/基础数据/供应商档案_详细设计说明书.md":se,"/PRD/基础数据/储存地点_详细设计说明书.md":oe,"/PRD/基础数据/客供关系映射_详细设计说明书.md":le,"/PRD/基础数据/客户档案_详细设计说明书.md":ce,"/PRD/基础数据/客户特殊要求_详细设计说明书.md":pe,"/PRD/基础数据/工艺路线_详细设计说明书.md":ue,"/PRD/基础数据/物料产品档案_详细设计说明书.md":de,"/PRD/基础数据/物料分类_详细设计说明书.md":me,"/PRD/基础数据/生产班组_详细设计说明书.md":ge,"/PRD/基础数据/计量单位_详细设计说明书.md":Te,"/PRD/基础数据与质量主数据_需求文档.md":Ae,"/PRD/实验室需求文档.md":Se,"/PRD/执行与控制/IQC来料检验与MRB异常处理详细设计文档.md":Ce,"/PRD/执行与控制/实验室检测任务管理详细设计文档.md":Re,"/PRD/执行与控制/检验任务自动生成与触发详细设计文档.md":Ie,"/PRD/知识库与培训/受控文档管理_详细设计文档.md":Ee,"/PRD/舜富PLM接口文档 .md":ye,"/PRD/质量主数据/不良现象与缺陷库_详细设计说明书.md":De,"/PRD/质量主数据/抽样方案管理_详细设计说明书.md":Pe,"/PRD/质量主数据/检验方法管理_详细设计说明书.md":ve,"/PRD/质量主数据/检验模板管理_详细设计说明书.md":Le,"/PRD/质量主数据/检验计划模型设计方案.md":fe,"/PRD/质量主数据/检验项目管理_详细设计说明书.md":he,"/PRD/质量主数据/质量检验计划与方案_详细设计说明书.md":_e,"/PRD/质量主数据/量检具台账_详细设计说明书.md":Ne}),e=on([]),a=on(null),r=c=>{const l=[];for(const[u,m]of Object.entries(c)){const d=u.match(/\/PRD\/(.+)$/);if(!d)continue;const S=d[1].split("/");let g=l,R="";S.forEach((D,M)=>{R+=(R?"/":"")+D;const L=M===S.length-1;let v=g.find(z=>z.title===D);v||(v={title:D,key:R,isLeaf:L,selectable:L},L?v.content=m:v.children=[],g.push(v)),L||(g=v.children)})}return l};On(()=>{e.value=r(n)});const s=(c,l)=>{const u=l.node.dataRef;u&&u.isLeaf&&(a.value=u)},o=ln(()=>a.value?a.value.title.toLowerCase().endsWith(".md"):!1),i=ln(()=>{var c;return!o.value||!((c=a.value)!=null&&c.content)?"":A.parse(a.value.content)});return(c,l)=>{const u=cn("a-tree"),m=cn("a-empty");return f(),b("div",It,[U("div",Et,[l[0]||(l[0]=U("div",{class:"sidebar-header"},[U("h3",null,"需求文档 (PRD)")],-1)),e.value.length>0?(f(),Un(u,{key:0,"tree-data":e.value,"default-expand-all":!0,onSelect:s,blockNode:""},null,8,["tree-data"])):(f(),b("div",yt," 未找到文档 "))]),U("div",Dt,[a.value?(f(),b(kn,{key:0},[U("h2",Pt,pn(a.value.title),1),o.value?(f(),b("div",{key:0,class:"markdown-body",innerHTML:i.value},null,8,vt)):(f(),b("pre",Lt,pn(a.value.content),1))],64)):(f(),b("div",ft,[wn(m,{description:"请在左侧选择要查看的文档"})]))])])}}}),bt=Qn(ht,[["__scopeId","data-v-8e34b5d5"]]);export{bt as default};
